...
Email: \htmladdnormallink{michalis@camelot.homedns.org}{mailto://michalis@camelot.homedns.org} \\
WWW: \htmladdnormallink{http://www.camelot.homedns.org/\~{}michalis/grammar\_compression.php}{http://www.camelot.homedns.org/~michalis/grammar_compression.php}
...
\begin{itemize}
  \item
    In the archive there's a binary compiled for Linux.

  \item
    You should compile everything using
    \htmladdnormallink{FreePascal}{http://www.freepascal.org/}, version >= 2.0.2.
...
\end{verbatim}
  ...
  \item
    In subdirectory \texttt{apidoc/} you will find documentation
    of units in this project as generated by
    \htmladdnormallink{pasdoc}{http://pasdoc.sourceforge.net/}.

  \item
    In subdirectory \texttt{units/} there are some of my
    general-purpose ObjectPascal units. I needed them for this project.
    Current, full version of these units, with documentation and examples,
    can always be found on
    \htmladdnormallink{my WWW page}{http://www.camelot.homedns.org/~michalis/}.
