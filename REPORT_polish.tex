...
\end{verbatim}
  ...
  \item
    Pliki w katalogu \texttt{units/} zawieraj± czê¶æ moich modu³ów
    ogólnego przeznaczenia w ObjectPascalu, które wykorzysta³em w tym
    projekcie. Aktualn± wersjê i dkoumentacjê tych modu³ów zawsze mo¿na znale¼æ na
    \htmladdnormallink{mojej stronie WWW}{http://www.camelot.homedns.org/~michalis/}.
